...
Figure~\ref{rotation1} shows the measured density gradient scale
...
\begin{figure}[!htbp]
\centerline{
\includegraphics[width=3.5truein]{rotation1}}
\caption{\label{rotation1} (a)Gradient scale length versus shearing rate. (b)Particle flux normalized to no-shear
...
as shown in Figure~\ref{nonmodal}(a).  Consistent with this observation, transient growth of linearly-stable
flute-like ($k_\parallel = 0$) modes is observed, as shown in
Figure~\ref{nonmodal}(b).  

\begin{figure}[!htbp]
\centerline{\includegraphics[width=3.5truein]{nonmodal}}
\caption{(a) Linear evolution of energy starting from a turbu-
lent initial state. The $n = 0$ curves have an initial period
of transient growth before exponentially decaying. b) Lin-
